...
A\* quickly finds a set of position waypoints for a quadrotor to follow, but
...
quadrotor will fly in a straight line from point to point and stopping at every
...
worried about the total force the quadrotor might have to generate throughout
