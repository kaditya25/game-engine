...
namespace game_engine {
    ...
    //  * IMPLEMENTATION *
    //  ******************
    // The presubmission trajectory vetter returns exactly the response from the mediation layer. This interface is
    // available for student use to pass in a trajectory and check its validity before sending to the mediation
    // layer for submission. This tool should minimize erroneous submissions to the mediation layer. The
    // TrajectoryCode returns the Code (found in util/trajectory_code.h), as well as the value and index of the
