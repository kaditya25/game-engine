...
namespace game_engine {
  ...
  ExampleAutonomyProtocol::UpdateTrajectories() {
    ...
    if (firstTime) {
      // TODO: Add setup for inilization
    }

    // Obtain current balloon positions and popped states
    // TODO: Obtain positoin of red_balloon_pos
    //                          blue_balloon_pos
    // TODO: Obtain balloon states red_balloon_popped
    //                             blue_balloon_popped
    ...
    // TODO: Set Goal Position threshold
    ...
    if (halt ||
      ...
      for (size_t idx = 0; idx < 20; ++idx) {
        ...
        // TODO: Pushback trajectory
      }
      // TODO: return this trajectory
    }
    ...
    for (size_t idx = 0; idx < N; ++idx) {
      ...
      // generate accelerations using Chain rule
      ...
      // TODO: Push Eigen instance into trajectory vector
      }
    // Construct a trajectory from the trajectory vector
    // TODO: Call trajectory constructor
    ...
    switch (check_trajectory_before_submission.code) {
      ...
      case MediationLayerCode::TimeBetweenPointsExceedsMaxTime: {
        ...
        std::cout << "Prevet: Shorten time between trajectory points."
                  << std::endl;
        std::cout << "Prevet: Time violation: "
                  << check_trajectory_before_submission.value << std::endl;
        break;
      }
      default:
        std::cout << "Prevet code: "
                  << static_cast<int>(check_trajectory_before_submission.code)
                  << std::endl;
        std::cout << "Prevet value: "
                  << check_trajectory_before_submission.value << std::endl;
        std::cout << "Prevet index: "
                  << check_trajectory_before_submission.index << std::endl;
    }
    ...
    // TODO: invoke visualizer, trajectory, and return
    return 0;
  }
}
