...
int main(int argc, char** argv) {
  ...
  // Start ROS
  ros::init(argc, argv, "manual_control_protocol", ros::init_options::NoSigintHandler);
...
//  blue_balloon_position_publisher_node->Publish(setStartPositionBlue);
  ...
  std::thread ap_thread_manual_control(
      [&]() {
        manual_control_protocol->Run(proposed_trajectory_clients, joy_mode, camera_mode);
      });
