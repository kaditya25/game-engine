...
namespace game_engine {
    ...
    BalloonPositionSubscriberNode(const std::string& topic,
      ...
      this->subscriber_ = node_handle_.subscribe(
          topic,
          1,
          &BalloonPositionSubscriberNode::SubscriberCallback,
          this);
    }

    void BalloonPositionSubscriberNode::
    SubscriberCallback(const geometry_msgs::Point& msg) {
