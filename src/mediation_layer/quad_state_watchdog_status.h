...
// Struct that contains information about the status of the QuadStateWatchdog.
// If the QuadStateWatchdog determines that a quadcopter has flown too close to
